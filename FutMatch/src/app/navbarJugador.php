    ...
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="d-flex align-items-center d-none d-md-flex ms-3">
          <a href="<?= PAGE_INICIO_JUGADOR ?>" 
             class="btn btn-dark me-2 <?= isActive('inicio-jugador', $current_page) ?>" 
             id="home" 
             title="Home">
          ...
          <a href="<?= PAGE_PARTIDOS_JUGADOR ?>" 
             class="btn btn-dark me-2 <?= isActive('partidos-jugador', $current_page) ?>" 
             id="botonMisPartidos" 
             title="Mis Partidos">
          ...
          <a href="<?= PAGE_EQUIPOS_LISTADO ?>" 
             class="btn btn-dark me-2 <?= isActive('equipos-listado', $current_page) ?>" 
             id="botonMiEquipo" 
             title="Mis Equipos">
          ...
          <a href="<?= PAGE_FOROS_LISTADO ?>" 
             class="btn btn-dark me-2 <?= isActive('foros-listado', $current_page) ?>" 
             id="botonForos" 
             title="Foros">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="<?= PAGE_PERFIL_JUGADOR_DETALLE ?>" 
           class="btn btn-dark me-2 d-none d-md-flex <?= isActive('perfil-jugador-detalle', $current_page) ?>" 
           id="botonPerfil" 
           title="Mi Perfil">
        ...
        <div class="d-none-custom d-md-flex align-items-center">
          ...
          <a href="<?= PAGE_LANDING ?>" class="btn btn-danger me-2 d-none d-lg-flex" id="btnCerrarSesion"
               title="Cerrar Sesión">
...
<div class="offcanvas offcanvas-start" 
  ...
  <div class="offcanvas-body">
    ...
    <div class="d-grid gap-2 mb-4">
      <a href="<?= PAGE_INICIO_JUGADOR ?>" 
         class="btn btn-dark text-start <?= isActive('inicio-jugador', $current_page) ?>" 
         title="Home">
        <i class="bi bi-house-door me-2"></i>Home
      </a>
      <a href="<?= PAGE_PARTIDOS_JUGADOR ?>" 
         class="btn btn-dark text-start <?= isActive('partidos-jugador', $current_page) ?>" 
         title="Mis Partidos">
        <i class="bi bi-calendar-event me-2"></i>Mis Partidos
      </a>
      <a href="<?= PAGE_EQUIPOS_LISTADO ?>" 
         class="btn btn-dark text-start <?= isActive('equipos-listado', $current_page) ?>" 
         title="Mis Equipos">
    ...
    <div class="d-grid gap-2 mb-4">
      <a href="<?= PAGE_CANCHAS_LISTADO ?>" 
         class="btn btn-dark text-start <?= isActive('canchas-listado', $current_page) ?>">
        <i class="bi bi-geo-alt me-2"></i>Explorar Canchas
      </a>
      <a href="<?= PAGE_PARTIDOS_LISTADO ?>" 
         class="btn btn-dark text-start <?= isActive('partidos-listado', $current_page) ?>">
        <i class="bi bi-people me-2"></i>Explorar Partidos
      </a>
      <a href="<?= PAGE_FOROS_LISTADO ?>" 
         class="btn btn-dark text-start <?= isActive('foros-listado', $current_page) ?>">
    ...
    <div class="mt-auto pt-3 border-top">
      <div class="d-grid gap-2">
        <a href="<?= PAGE_PERFIL_JUGADOR_DETALLE ?>" 
           class="btn btn-dark text-start <?= isActive('perfil-jugador-detalle', $current_page) ?>" 
           title="Mi Perfil">
        ...
        <a href="<?= PAGE_LANDING ?>" class="btn btn-danger text-start" 
           title="Cerrar Sesión">
