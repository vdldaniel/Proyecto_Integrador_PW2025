...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('[data-bs-target="#modalAbrirInscripciones"]').forEach(btn => {
    ...
    document.querySelectorAll('[data-bs-target="#modalSolicitudesTorneo"]').forEach(btn => {
        btn.addEventListener('click', function() {
            const torneoId = this.dataset.torneoId;
    ...
    document.querySelectorAll('[data-bs-target="#modalCancelarTorneo"]').forEach(btn => {
        btn.addEventListener('click', function() {
            const torneoId = this.dataset.torneoId;
    ...
    if (btnCrearTorneo) {
        btnCrearTorneo.addEventListener('click', function() {
            ...
            const modal = bootstrap.Modal.getInstance(document.getElementById('modalCrearTorneo'));
            if (modal) {
                modal.hide();
            }
        });
    ...
    const btnConfirmarAbrirInscripciones = document.getElementById('btnConfirmarAbrirInscripciones');
    if (btnConfirmarAbrirInscripciones) {
        btnConfirmarAbrirInscripciones.addEventListener('click', function() {
            ...
            const modal = bootstrap.Modal.getInstance(document.getElementById('modalAbrirInscripciones'));
            if (modal) {
                modal.hide();
            }
        });
    ...
    if (btnConfirmarCancelar) {
        btnConfirmarCancelar.addEventListener('click', function() {
            ...
            const modal = bootstrap.Modal.getInstance(document.getElementById('modalCancelarTorneo'));
            if (modal) {
                modal.hide();
            }
        });
