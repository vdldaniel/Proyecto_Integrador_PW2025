...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (e) {
    ...
    if (isValid) {
      ...
      showToast(
        "Si el email está registrado, recibirás un enlace de recuperación en tu bandeja de entrada. Por favor revisá también la carpeta de spam.",
        "info"
      );
      ...
      setTimeout(function () {
        window.location.href =
          "/Proyecto_Integrador_PW2025/FutMatch/public/HTML/auth/landing.php";
      }, 2000);
    } else {
