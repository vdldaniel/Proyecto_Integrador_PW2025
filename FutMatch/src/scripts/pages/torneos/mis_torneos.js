document.addEventListener('DOMContentLoaded', function () {
    ...
    const modalCancelarTorneoElement = document.getElementById('modalCancelarTorneo');
    ...
    async function loadTorneos() {
        torneosListContainer.innerHTML = '<div class="col-12 text-center py-5"><i class="bi bi-arrow-clockwise fa-spin me-2"></i> Cargando torneos...</div>';
        ...
        try {
            ...
            if (data.status === 'success') {
                ...
                torneosListContainer.innerHTML = '<div class="col-12 alert alert-danger">Error al cargar torneos: ' + data.message + '</div>';
            }

        } catch (error) {
            console.error('Error AJAX en loadTorneos:', error);
            showToast('Error de conexión o formato de datos al cargar la lista de torneos.', 'error');
