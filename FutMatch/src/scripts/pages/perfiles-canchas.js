...
class PerfilCanchaAdmin extends PerfilCanchaBase {
  ...
  configurarEventListenersAdmin() {
    ...
    const botonesGestionar = Array.from(
    ...
    botonesGestionar.forEach((boton) => {
      boton.addEventListener("click", (e) => {
        ...
        const torneoNombre = torneoElement
    ...
    if (btnVerPerfilCancha) {
      btnVerPerfilCancha.addEventListener("click", () =>
        this.verPerfilCompleto()
      );
    }

    // Botón guardar configuración del modal
    const btnGuardarConfig = document.getElementById(
  ...
  configurarFormularios() {
    ...
    if (tipoCancha && capacidad) {
      tipoCancha.addEventListener("change", () =>
        this.ajustarCapacidadSegunTipo()
      );
    }
  }
  ...
  gestionarTorneo(nombreTorneo) {
    ...
    this.showToast("Abriendo gestión de: ${nombreTorneo}", "info");
  }
  ...
  verPerfilCompleto() {
    ...
    this.showToast("Abriendo perfil completo...", "info");
  }
  ...
  cargarDatosEnModal() {
    ...
    const datos = {
      ...
      capacidad: document
        .getElementById("capacidadCancha")
        ?.textContent?.replace(" jugadores", ""),
    };

    // Llenar campos del modal
    if (datos.nombre)
      document.getElementById("editNombreCancha").value = datos.nombre;
  ...
  validarHorarios() {
    ...
    if (horaApertura && horaCierre) {
      ...
      if (cierre <= apertura) {
        ...
        document
          .getElementById("editHoraApertura")
          ?.classList.remove("is-invalid");
        document
          .getElementById("editHoraCierre")
          ?.classList.remove("is-invalid");
        return true;
      }
    }
