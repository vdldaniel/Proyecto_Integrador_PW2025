...
class AplicacionAgendaAdmin extends CalendarioBase {
  ...
  cargarDatosConfiguracion() {
    ...
    if (horaApertura)
      horaApertura.value = this.configuracionCancha.horaApertura;
    ...
    if (nombreComplejo)
      nombreComplejo.textContent = this.configuracionCancha.canchaInfo.nombre;
    if (direccionComplejo)
      direccionComplejo.textContent =
        this.configuracionCancha.canchaInfo.direccion;
    if (telefonoComplejo)
      telefonoComplejo.textContent =
        this.configuracionCancha.canchaInfo.telefono;
  }
  ...
  procesarFormularioReserva() {
    ...
    const datosReserva = {
      ...
      cancha: this.obtenerNombreCancha(
        document.getElementById("canchaReserva").value
      ),
