...
<body>
  ...
  <main class="container mt-4">
    ...
    <div class="row mb-4 align-items-center">
      ...
      <div class="col-md-6 text-end">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location.href='torneosExplorar.php'">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col-md-3 text-end">
                <button class="btn btn-primary btn-sm" onclick="window.location.href='torneoDetalle.php'">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-sm btn-outline-info" onclick="window.location.href='torneoDetalle.php'">
  ...
  <script src="<?= BASE_URL ?>src/scripts/pages/torneos-jugador.js"></script>
</body>
</html>