                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>9 jugadores</td>
                      <td>
                        <button class="btn btn-sm btn-info" onclick="window.location.href='<?= PAGE_ADMIN_EQUIPO_PERFIL ?>'">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>30/11/2025</td>
                      <td>
                        <button class="btn btn-sm btn-outline-info" onclick="window.location.href='<?= PAGE_ADMIN_TORNEO_DETALLE ?>'">
