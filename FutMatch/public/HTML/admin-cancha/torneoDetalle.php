                ...
                <div class="bracket-wrapper">
                  ...
                  <div class="bracket-column">
                    ...
                    <div class="bracket-group">
                      <div class="team-box" onclick="window.location.href='<?= PAGE_ADMIN_EQUIPO_PERFIL ?>'">
                        Los Cracks FC
                      </div>
                  ...
                  <div class="bracket-column winners-column">
                    ...
                    <div class="winner-result">
                      <div class="winner-box completed" onclick="window.location.href='<?= PAGE_ADMIN_EQUIPO_PERFIL ?>'">
                        <strong>Los Cracks FC</strong>
                        <div class="score">3-1</div>
                        <button class="btn btn-xs btn-outline-light mt-1" onclick="event.stopPropagation(); window.location.href='#'">
                          Ver Partido
                        </button>
                      </div>
                      <div class="connector-right"></div>
                              ...
                              <div class="col-md-6 mb-3">
                                <div class="card">
                                  <div class="card-body">
                                    ...
                                    <button class="btn btn-sm btn-outline-info w-100" onclick="window.location.href='#'">
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-sm btn-outline-info" onclick="window.location.href='<?= PAGE_ADMIN_EQUIPO_PERFIL ?>'">
                ...
                <div class="row">
                  <div class="col-md-6 col-xl-4 mb-4">
                    <div class="card h-100">
                      ...
                      <div class="card-footer">
                        <button class="btn btn-outline-info btn-sm w-100" onclick="window.location.href='<?= PAGE_ADMIN_EQUIPO_PERFIL ?>'">
                          <i class="bi bi-eye"></i> Ver perfil
                        </button>
                      </div>
                    </div>
